...
<head>
    ...
    <title>Login Administrator|Presensi GPS</title>
    <script defer data-api="/stats/api/event" data-domain="preview.tabler.io" src="{{ asset('tabler/stats/js/script.js') }}"></script>
