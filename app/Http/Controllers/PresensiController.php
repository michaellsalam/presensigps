        ...
        if ($radius > $lok_kantor->radius) {
            ...
            if ($cek > 0) {
                ...
                if ($update) {
                    ...
                    echo 'error|Maaf anda gagal Absen, Hubungi Administrator !|out';
                }
            } else {
                $data = [
                    'nik' => $nik,
                ...
                if ($simpan) {
                    echo 'success|Terima kasih, Selamat Anda Berhasil Absen|in';
                    Storage::put($file, $image_base64);
                } else {
                    echo 'error|Maaf anda gagal Absen, Hubungi Administrator !|in';
                }
            }
        }
    }
